# ============================================================================
# Файл: src/user_settings.py (полностью обновлён)
# ============================================================================
#!/usr/bin/env python3
...
PROXY_TELEGRAM_CALLS_PER_SECOND = 5.0   # ИЗМЕНЕНО: было 100

# Максимальный размер ответа от Telegram (байт). Если ответ больше – обрезается.
PROXY_MAX_RESPONSE_SIZE_BYTES = 9_048_576  # 9 МБ
...
PROXY_CHANNEL_RETRY_ATTEMPTS = 1        # ИЗМЕНЕНО: было 3
...
PROXY_CHANNEL_RETRY_DEADLINE = 5.0      # ИЗМЕНЕНО: было 1.0
...
# ============================================================
# БЛОК 12: НОВЫЕ ПАРАМЕТРЫ ДЛЯ КАРАНТИНА И АДАПТИВНОСТИ
# ============================================================

# Количество запусков, в течение которых канал может быть плохим до отключения
PROXY_GRACE_PERIOD_RUNS = 5

# Процентиль для адаптивного порога здоровья каналов (0-100)
PROXY_ADAPTIVE_THRESHOLD_PERCENTILE = 20

# Минимальное число записей для вычисления адаптивного порога
PROXY_MIN_RECORDS_FOR_ADAPTIVE = 10
...
# НОВЫЕ ПАРАМЕТРЫ
GRACE_PERIOD_RUNS = _get_int('PROXY_GRACE_PERIOD_RUNS', PROXY_GRACE_PERIOD_RUNS, 1, 20)
ADAPTIVE_THRESHOLD_PERCENTILE = _get_int('PROXY_ADAPTIVE_THRESHOLD_PERCENTILE', PROXY_ADAPTIVE_THRESHOLD_PERCENTILE, 5, 50)
MIN_RECORDS_FOR_ADAPTIVE = _get_int('PROXY_MIN_RECORDS_FOR_ADAPTIVE', PROXY_MIN_RECORDS_FOR_ADAPTIVE, 3, 50)
